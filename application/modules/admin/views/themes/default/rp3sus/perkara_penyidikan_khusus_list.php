<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Perkara Penyidikan Khusus</li>
  </ol>
</section>
        <!-- Main content -->
<section class="content">
  <div class="box box-default">
    <div class="box-header">
      <h3 class="box-title fc-toolbar">List Perkara Penyidikan Khusus</h3>
              ...
              <tr class="accordion-toggle"  data-toggle="collapse" data-target="#collapseOne">
                ...
                <td>
                  <div class="btn-group" role="group" aria-label="...">
                    ...
                    <a href='<?= base_url() ?>admin/register/rp3sus/geledah' class="btn btn-default btn-sm">Geledah</a>
                    <a href='<?= base_url() ?>admin/register/rp3sus/naik_tahapan' class="btn btn-success btn-sm">Tahapan</a>
                  </div>
                </td>
              </tr>
              <tr>

            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
              <div class="box box-default">
                <div class="box-header with-border">
                  <h3 class="box-title">Ubah Kategori Subyek</h3>
                  <!-- <div class="box-tools pull-right">
                    <a href="<?= base_url() ?>admin/register/kasus" class="btn btn-warning">Back to list kasus</a>
                  </div> -->
                </div>
                <form role="form" method="POST" action="<?=base_url('admin/administrasi/kategori_subyek/edit/'.$tabel_kategori_subyek->id)?>">
                  <div class="box-body">
                      ...
                      <div class="row"> 
                        <div class="col-lg-12 col-sm-12">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" value="<?=$tabel_kategori_subyek->kategori_subyek?>" class="form-control" placeholder="Enter ..." id="kategori_subyek" name="kategori_subyek"></input>
                          </div>

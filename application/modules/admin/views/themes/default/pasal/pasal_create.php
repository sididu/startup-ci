          ...
          <div class="row"> 
            <div class="col-lg-6 col-md-6 col-sm-12">
              <div class="box box-default">
                ...
                <form role="form" method="POST" action="<?=base_url('admin/administrasi/pasal/create')?>">
                  <div class="box-body">
                      ...
                      <div class="row"> 
                        <div class="col-lg-12 col-sm-12">
                          ...
                          <div class="form-group">
                            <label>Ayat</label>
                            <input type="text" class="form-control" placeholder="Enter ..." id="ayat" name="ayat"></input>
                          </div>

                          <!-- Alamat -->
                          <div class="form-group">
                            <label>Keterangan</label>
                            <input type="text"  class="form-control" placeholder="Enter ..." id="keterangan" name="keterangan"></input>
                          </div>
                          <!-- Kota -->
                          <div class="form-group">
                            <label>Jumalah Masa Hukuman</label>
                            <input type="text" class="form-control" placeholder="Enter ..." id="jumlah_masa_hukuman" name="jumlah_masa_hukuman">
                          </div>
                        </div>
                          <!-- /.form group -->
                      </div>

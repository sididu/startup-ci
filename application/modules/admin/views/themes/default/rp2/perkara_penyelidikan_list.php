              ...
              <tr class="accordion-toggle"  data-toggle="collapse" data-target="#collapseOne">
                ...
                <td>
                  <div class="btn-group" role="group" aria-label="...">
                    <a href='<?= base_url('admin/register/rp2/edit/'.$list['id']) ?>' class="btn btn-default btn-sm"><i class="glyphicon glyphicon-pencil"></i></a>
                    <a href='<?= base_url('admin/register/rp2/delete/'.$list['id']) ?>' class="btn btn-default btn-sm"><i class="glyphicon glyphicon-minus-sign"></i></a>
                    <a href='<?= base_url() ?>admin/register/rp2/geledah' class="btn btn-default btn-sm">Geledah</a>
                    <a href='<?= base_url() ?>admin/register/rp2/naik_dik_mum' class="btn btn-success btn-sm">Dik-Mum</a>
                  </div>
                </td>
              </tr>
              <tr>

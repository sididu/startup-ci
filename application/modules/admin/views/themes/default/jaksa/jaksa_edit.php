            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
              <div class="box box-default">
                <div class="box-header with-border">
                  <h3 class="box-title">Ubah Jaksa</h3>
                  <!-- <div class="box-tools pull-right">
                    <a href="<?= base_url() ?>admin/register/kasus" class="btn btn-warning">Back to list kasus</a>
                  </div> -->
                </div>
                <form role="form" method="POST" action="<?=base_url('admin/administrasi/jaksa/edit/'.$tabel_jaksa->id)?>">
                  <div class="box-body">
                      ...
                      <div class="row"> 
                        <div class="col-lg-12 col-sm-12">
                          ...
                          <div class="form-group">
                            <label>NIP</label>
                            <input type="text" value="<?=$tabel_jaksa->nip?>" class="form-control" placeholder="Enter ..." id="nip" name="nip"></input>
                          </div>

                          <!-- Alamat -->
                          <div class="form-group">
                            <label>Nama Jaksa</label>
                            <input type="text" value="<?=$tabel_jaksa->nama_jaksa?>" class="form-control" placeholder="Enter ..." id="nama_jaksa" name="nama_jaksa"></input>
                          </div>
                          <!-- Kota -->
                          <div class="form-group">
                            <label>Pangkat</label>
                            <input type="text" value="<?=$tabel_jaksa->pangkat?>" class="form-control" placeholder="Enter ..." id="pangkat" name="pangkat">
                          </div>
                        </div>
                          <!-- /.form group -->
                      </div>

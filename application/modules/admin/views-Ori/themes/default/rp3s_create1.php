<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h2>
                SURAT PERINTAH PENYIDIKAN UMUM
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form role="form" method="POST" action="<?=base_url('admin/rp3s/create1/'.$rp2->id)?>">
                                <div class="form-group">
                                    <label>Id Input</label>
                                    <input class="form-control" value="<?= $rp2->id ?>" id="id" name="id" placeholder="Auto generated" disabled="1">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="datepicker form-control" value="<?= $rp2->tanggal_berhenti ?>" placeholder="Enter tanggal surat" id="tanggal_surat" name="tanggal_surat">
                                        </div>
                                        <div class="form-group">
